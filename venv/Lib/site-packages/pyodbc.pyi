...
class Cursor:
    ...
    def statistics(
        ...
        ...
    def rowIdColumns(
        self, table: str, catalog: Optional[str] = None, schema: Optional[str] = None, nullable: bool = True
    ) -> Cursor:
    ...
    def rowVerColumns(
        ...
        """
        ...
    def primaryKeys(self, table: str, catalog: Optional[str] = None, schema: Optional[str] = None) -> Cursor:
    ...
    def foreignKeys(
        ...
        ...
    def procedures(
        self, procedure: Optional[str] = None, catalog: Optional[str] = None, schema: Optional[str] = None
    ) -> Cursor:
