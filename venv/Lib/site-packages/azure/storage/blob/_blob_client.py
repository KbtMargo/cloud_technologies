...
from typing import IO, TYPE_CHECKING, Any, AnyStr, Dict, Iterable, List, Optional, Tuple, Union, cast, overload
...
from ._encryption import _ERROR_UNSUPPORTED_METHOD_FOR_ENCRYPTION, StorageEncryptionMixin
...
class BlobClient(StorageAccountHostsMixin, StorageEncryptionMixin):  # pylint: disable=too-many-public-methods
    ...
    def list_page_ranges(
        ...
        **kwargs: Any,
        ...
        return ItemPaged(command, results_per_page=results_per_page, page_iterator_class=PageRangePaged)
    ...
    @distributed_trace
    def append_block(
        self, data: Union[bytes, str, Iterable[AnyStr], IO[AnyStr]], length: Optional[int] = None, **kwargs: Any
    ...
    def append_block_from_url(
        ...
        **kwargs: Any,
        ...
        try:
            return cast(Dict[str, Union[str, datetime, int]], self._client.append_blob.append_block_from_url(**options))
        except HttpResponseError as error:
            process_storage_error(error)
