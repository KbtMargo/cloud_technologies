    ...
    def generate_blob(
        ...
        **kwargs: Any,
        ...
        sas.add_resource_signature(
            self.account_name, self.account_key, resource_path, user_delegation_key=self.user_delegation_key
        )
...
class _BlobSharedAccessHelper(_SharedAccessHelper):
    ...
    def get_token(self) -> str:
        ...
        return "&".join(
            [f"{n}={url_quote(v)}" for n, v in self.query_dict.items() if v is not None and n not in exclude]
        )
