...
import os
from typing import IO, TYPE_CHECKING, Any, AnyStr, Dict, Iterable, Optional, Union, cast
...
from ._shared_access_signature import generate_account_sas, generate_blob_sas, generate_container_sas
