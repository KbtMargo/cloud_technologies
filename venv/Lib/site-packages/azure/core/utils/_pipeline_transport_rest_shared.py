...
from typing import IO, TYPE_CHECKING, Callable, Iterator, List, Optional, Sequence, Tuple, Type, Union, cast
...
if TYPE_CHECKING:
    ...
    from azure.core.pipeline.transport import (
        HttpResponse as PipelineTransportHttpResponse,  # pylint: disable=non-abstract-transport-import
    )
    from azure.core.pipeline.transport._base import _HttpResponseBase as PipelineTransportHttpResponseBase
    from azure.core.rest._helpers import FileContent, FilesType, FileType
