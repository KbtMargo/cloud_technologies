...
import base64
import time
from typing import TYPE_CHECKING, Any, MutableMapping, Optional, TypeVar, Union, cast

from azure.core.credentials import SupportsTokenInfo, TokenCredential, TokenProvider, TokenRequestOptions
...
if TYPE_CHECKING:
    from azure.core.credentials import AccessToken, AccessTokenInfo, AzureKeyCredential, AzureSasCredential
